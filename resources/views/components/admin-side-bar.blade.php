<div class="drawer-side is-drawer-close:overflow-visible p-2">
    ...
    <div
        ...
        <ul class="menu w-full gap-1 grow">
            ...
            <!-- List item -->
            <li>
                <a href="{{ url('/admin/queue-types') }}">
                    <button class="is-drawer-close:tooltip is-drawer-close:tooltip-right flex items-center gap-3 h-8" data-tip="Queue Types">
                        ...
                        <span class="is-drawer-close:hidden">Queue Types</span>
                    </button>
                </a>
            </li>
            ...
            <!-- List item -->
            <li>
                <a href="{{ url('/get-ticket-page') }}" target="_blank">
                    <button class="is-drawer-close:tooltip is-drawer-close:tooltip-right flex items-center gap-3 h-8" data-tip="Generate Ticket Window">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="size-4">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                            <path d="M9 5h-2a2 2 0 0 0 -2 2v12a2 2 0 0 0 2 2h10a2 2 0 0 0 2 -2v-12a2 2 0 0 0 -2 -2h-2" />
                            <path d="M9 3m0 2a2 2 0 0 1 2 -2h2a2 2 0 0 1 2 2v0a2 2 0 0 1 -2 2h-2a2 2 0 0 1 -2 -2z" />
                        ...
                        <span class="is-drawer-close:hidden">Generate Ticket Window</span>
                    </button>
                </a>
            </li>
